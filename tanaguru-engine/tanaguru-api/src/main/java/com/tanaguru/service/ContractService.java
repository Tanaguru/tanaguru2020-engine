...
public interface ContractService {
     ...
     */
    Contract createContract(User owner, String name, int auditLimit, int projectLimit, boolean restrictDomain, Date contractEnd, boolean allowCreateProject, boolean allowModifyProject);
